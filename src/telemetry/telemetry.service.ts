...
import { AdditionalAttributeData, TelemetryConfig as TelemetryConfig } from './types/config'
...
import { Attributes, Context, context, propagation, Span, trace, Tracer } from '@opentelemetry/api'
